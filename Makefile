...
layout-images:
	...
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_0_base.txt -qo ed_layout_0_base.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*1'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_1_cole.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_1_cole.txt -qo ed_layout_1_cole.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*2'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_2_work.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_2_work.txt -qo ed_layout_2_work.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*3'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_3_game.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_3_game.txt -qo ed_layout_3_game.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*4'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_4_symb.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_4_symb.txt -qo ed_layout_4_symb.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*5'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_5_nump.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_5_nump.txt -qo ed_layout_5_nump.png
	cat keyboards/ergodox_ez/keymaps/mine/keymap.c |grep '\*\*\*6'|sed -e 's/\*\*[0-9]\*//' > /tmp/ed_layout_6_medi.txt
	pango-view --margin "200px 0 0 0" --font Fira\ Code\ 18 --background=#1c1c1c --foreground=#5f875f --width 1920  --height 1080 /tmp/ed_layout_6_medi.txt -qo ed_layout_6_medi.png
